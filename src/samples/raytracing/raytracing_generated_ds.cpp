...
void RayTracer_Generated::InitAllGeneratedDescriptorSets_CastSingleRay()
{
  ...
  // descriptor set #1: RayTraceCmd (["rayPosAndNear","rayDirAndFar","out_color","m_pAccelStruct"])
  {
    ...
    descriptorImageInfo[2].imageView   = CastSingleRay_local.out_colorView;
    descriptorImageInfo[2].imageLayout = VK_IMAGE_LAYOUT_GENERAL;
    descriptorImageInfo[2].sampler     = VK_NULL_HANDLE;
    ...
    writeDescriptorSet[2].pImageInfo       = &descriptorImageInfo[2];
    writeDescriptorSet[2].pTexelBufferView = nullptr; 
